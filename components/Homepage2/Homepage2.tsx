  ...
  return (
    ...
    >
      <div className={clsx(classes.root, "root d-flex")}>
        <div style={{ backgroundImage: `url('${image.src}')`, backgroundAttachment: 'fixed', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }} className={clsx(classes.left, "w-50")}>&nbsp;</div>
        <div className={clsx(classes.right, "w-50 align-self-center", visibility &&
